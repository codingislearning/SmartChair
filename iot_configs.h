 ...
 * WiFi setup
 */
#define IOT_CONFIG_WIFI_SSID            "MSFTLAB"
 ...
 */
#define IOT_CONFIG_CONNECTION_STRING    "HostName=smartChair-iot-labs.azure-devices.net;DeviceId=Esp8266;SharedAccessKey=hFHZTuRWlv+o8kVIXCDjMTKoUGJecwWnZ+t9WULCqyY="
